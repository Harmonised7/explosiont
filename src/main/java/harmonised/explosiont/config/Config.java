...
public class Config
{
    ...
    public static class ConfigImplementation
    {
        ...
        public ConfigHelper.ConfigValueListener<Boolean> dimensionFilterType;
        ...
        public ConfigImplementation(ForgeConfigSpec.Builder builder, ConfigHelper.Subscriber subscriber)
        {
            builder.push("Global");
            {
                ...
                this.dimensionFilterType = subscriber.subscribe(builder
                        .comment("Should the explosiont:dimension_filter Dimension Tag be a Whitelist, or a Blacklist? (TRUE:WHITELIST, FALSE:BLACKLIST)")
                        .translation("pmmo.dimensionFilterType")
                        .define("dimensionFilterType", false));
